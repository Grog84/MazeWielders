...
public class CameraMovement : MonoBehaviour {
    ...
    public void StartFollowing(Transform transform)
    {
        ...
        MoveToPosition(followTransform.position);
    }
    ...
    public IEnumerator ZoomToCenter()
    {
        MoveToCenter();
        yield return null;
    }

    public void CameraSetRowsAndColumns(MapManager mapManager)
    {
        SetRowsAndColumns(mapManager);
    }
    ...
    void Update() {
        ...
        if (isFollowing)
        {
            MoveToPosition(followTransform.position, false);
        }
        else
        {
            MoveCamera();
